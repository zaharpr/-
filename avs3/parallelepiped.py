...
# def out(parallelepiped, out_stream):
#     out_stream.out(f"Parallelepiped: a = {parallelepiped[2]}  b = {parallelepiped[3]} c = {parallelepiped[4]},"
#                    f" density = {parallelepiped[1]}, SurfaceArea = {parallelepiped[5]}")
